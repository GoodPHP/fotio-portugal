...
const DURATION_OPTIONS = [
  { value: 'standard', label: { en: 'Standard', pt: 'Padrão' } },
  { value: 'extended', label: { en: 'Extended', pt: 'Alargada' } },
  { value: 'fullday', label: { en: 'Full day', pt: 'Dia completo' } },
] as const;
...
const UI = {
  ...
  time: { en: 'Time (optional)', pt: 'Hora (opcional)' },
  duration: { en: 'Session duration', pt: 'Duração da sessão' },
  addons: { en: 'Add-ons', pt: 'Extras' },
  express: { en: 'Express 24h delivery', pt: 'Entrega expresso em 24 h' },
  second: { en: 'Second photographer', pt: 'Segundo fotógrafo' },
  name: { en: 'Full name', pt: 'Nome completo' },
  email: { en: 'Email', pt: 'E-mail' },
  phone: { en: 'Phone', pt: 'Telemóvel' },
  remarks: { en: 'Notes (optional)', pt: 'Observações (opcional)' },
  quoteTitle: { en: 'Tailored quote', pt: 'Orçamento à medida' },
  quoteBody: {
    en: 'We reply on WhatsApp within minutes with a price tailored to your session.',
    pt: 'Respondemos no WhatsApp em poucos minutos com um preço à medida da sua sessão.',
  },
  perk1: { en: 'No obligation', pt: 'Sem compromisso' },
  perk2: { en: 'Personalised price', pt: 'Preço personalizado' },
  perk3: { en: 'Fast reply', pt: 'Resposta rápida' },
  reference: { en: 'Reference', pt: 'Referência' },
  submit: { en: 'Send request', pt: 'Enviar pedido' },
  sending: { en: 'Sending…', pt: 'A enviar…' },
  successTitle: { en: 'Request received!', pt: 'Pedido recebido!' },
  successBody: { en: 'We are opening WhatsApp to confirm the details with you.', pt: 'Vamos abrir o WhatsApp para confirmar os detalhes consigo.' },
  whatsapp: { en: 'Open WhatsApp', pt: 'Abrir o WhatsApp' },
  errName: { en: 'Enter your name.', pt: 'Indique o seu nome.' },
  errEmail: { en: 'Invalid email.', pt: 'E-mail inválido.' },
  errPhone: { en: 'Invalid phone.', pt: 'Telemóvel inválido.' },
  errDate: { en: 'Choose a date.', pt: 'Escolha uma data.' },
  errSubmit: { en: 'Submission error. Try again or use WhatsApp.', pt: 'Erro no envio. Tente de novo ou use o WhatsApp.' },
} as const;
